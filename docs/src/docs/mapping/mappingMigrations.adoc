...
The default strategy is `'alias'` as it is the only strategy that can achieve zero-downtime migrations and thus https://www.elastic.co/blog/changing-mapping-with-zero-downtime[recommended by Elasticsearch]
...
This is the migration strategy https://www.elastic.co/blog/changing-mapping-with-zero-downtime[recommended by Elasticsearch].
