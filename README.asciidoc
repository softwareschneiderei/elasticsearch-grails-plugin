[![CI](https://github.com/grails-plugins/grails-elasticsearch/actions/workflows/ci.yml/badge.svg?event=push)](https://github.com/grails-plugins/grails-elasticsearch/actions/workflows/ci.yml)
